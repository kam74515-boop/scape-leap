...
import { FileText, MessageSquare, Rocket } from "@/icons";
// components
...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: FileText,
      action: () => {
        window.open("https://formscape.com", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: MessageSquare,
      action: () => {
        window.open("mailto:support@formscape.com", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
