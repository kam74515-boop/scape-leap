    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {EMPTY_STATE_DATA.map((item) => {
          ...
          return (
            <div key={item.id} className="flex flex-col rounded-xl border border-subtle bg-surface-1 p-4 shadow-sm">
              <div
                className={cn("mb-3 grid size-9 place-items-center rounded-full border border-subtle bg-surface-1 text-placeholder", {
                  "border-transparent bg-accent-primary/10 text-accent-primary": !isStateComplete,
                })}
              >
