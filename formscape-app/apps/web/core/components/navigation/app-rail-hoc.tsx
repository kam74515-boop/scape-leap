...
export function withDockItems<P extends WithDockItemsProps>(WrappedComponent: React.ComponentType<P>) {
  const ComponentWithDockItems = observer(function ComponentWithDockItems(props: Omit<P, keyof WithDockItemsProps>) {
    ...
    const dockItems: (AppSidebarItemData & { shouldRender: boolean })[] = [
      {
        label: "项目",
        icon: <ProjectsIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/`,
      ...
      {
        label: "画布",
        icon: <CanvasIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/canvas`,
        isActive: is("canvas"),
        shouldRender: true,
      },
      {
        label: "3D模型",
        icon: <SpaceIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/space`,
        isActive: is("space"),
        shouldRender: true,
      },
      {
        label: "客户",
        icon: <CustomersIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/customers`,
      ...
      {
        label: "生态库",
        icon: <LibraryIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/library`,
        isActive: is("library"),
        shouldRender: true,
      },
      {
        label: "团队管理",
        icon: <UsersIcon className="size-5" strokeWidth={1.75} />,
        href: `/${ws}/users`,
      ...
      {
        label: "设置",
        icon: <SettingsIcon className="size-5" strokeWidth={1.75} />,
