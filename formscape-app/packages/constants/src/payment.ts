 ...
 */
export const TALK_TO_SALES_URL = "mailto:support@formscape.ai";
...
export const SUBSCRIPTION_REDIRECTION_URLS: Record<EProductSubscriptionEnum, Record<TBillingFrequency, string>> = {
  ...
  [EProductSubscriptionEnum.PRO]: {
    month: "https://formscape.com/upgrade/pro/self-hosted?plan=month",
    year: "https://formscape.com/upgrade/pro/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.BUSINESS]: {
    month: "https://formscape.com/upgrade/business/self-hosted?plan=month",
    year: "https://formscape.com/upgrade/business/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.ENTERPRISE]: {
    month: TALK_TO_SALES_URL,
    year: TALK_TO_SALES_URL,
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: "https://formscape.com/pro",
  [EProductSubscriptionEnum.BUSINESS]: "https://formscape.com/business",
  [EProductSubscriptionEnum.ENTERPRISE]: "https://formscape.com/business",
};
