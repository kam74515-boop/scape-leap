...
// 构境官网 / 支持（可按部署覆盖）
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://formscape.com";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@formscape.ai";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = process.env.VITE_MARKETING_PRICING_URL || "https://formscape.com/pricing";
export const MARKETING_CONTACT_US_PAGE_LINK = process.env.VITE_MARKETING_CONTACT_URL || "https://formscape.com/contact";
export const MARKETING_PLANE_ONE_PAGE_LINK = process.env.VITE_MARKETING_HOME_URL || "https://formscape.com";
